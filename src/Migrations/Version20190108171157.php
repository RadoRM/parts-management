 ...
 */
final class Version20190108171157 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mouvement ADD famille_id INT DEFAULT NULL, ADD sous_famille_id INT DEFAULT NULL, CHANGE piece_id fournisseur_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE mouvement ADD piece_id INT DEFAULT NULL, DROP fournisseur_id, DROP famille_id, DROP sous_famille_id');
