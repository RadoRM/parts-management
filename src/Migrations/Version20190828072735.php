 ...
 */
final class Version20190828072735 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE piece (id INT AUTO_INCREMENT NOT NULL, fournisseur_id INT DEFAULT NULL, famille_id INT DEFAULT NULL, sous_famille_id INT DEFAULT NULL, location VARCHAR(255) DEFAULT NULL, stock_quantity INT NOT NULL, INDEX IDX_44CA0B23670C757F (fournisseur_id), INDEX IDX_44CA0B2397A77B84 (famille_id), INDEX IDX_44CA0B2371DF2E6E (sous_famille_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE mouvement (id INT AUTO_INCREMENT NOT NULL, fournisseur_id INT DEFAULT NULL, famille_id INT DEFAULT NULL, sous_famille_id INT DEFAULT NULL, quantity INT NOT NULL, dimension NUMERIC(10, 2) NOT NULL, weight NUMERIC(10, 2) DEFAULT NULL, machine_attribution VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, type INT NOT NULL, INDEX IDX_5B51FC3E670C757F (fournisseur_id), INDEX IDX_5B51FC3E97A77B84 (famille_id), INDEX IDX_5B51FC3E71DF2E6E (sous_famille_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
